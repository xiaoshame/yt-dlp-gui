...
class MainFrame(wx.Frame):
    ...
    SUCC_REPORT_MSG = "Successfully downloaded {0} URL(s) in {1} day(s) {2} hour(s) {3} minute(s) {4} second(s)"
    DL_COMPLETED_MSG = "Downloads completed"
    URL_REPORT_MSG = "Total Progress: {0:.1f}% | Queued ({1}) Paused ({2}) Active ({3}) Completed ({4}) Error ({5})"
    ...
    OPEN_DIR_ERR = "Unable to open directory: '{dir}'. The specified path does not exist"
