...
class GeneralTab(TabPanel):
    ...
    def save_options(self):
        self.opt_manager.options["locale_name"] = tdict(self.LOCALE_NAMES)[self.language_combobox.GetValue()]
...
class ExtraTab(TabPanel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.cmdline_args_label = self.crt_statictext(("Youtube-dl command line options (e.g. --help)"))
